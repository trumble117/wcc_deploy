...
export FMW_HOME DOMAIN_BASE DOMAIN_NAME JAVA_HOME JAVA_VENDOR MEDIA_BASE ADMIN_SERVER_HOST OHS_INSTANCE_NAME OHS_NAME NM_PORT DB_URL SCHEMA_PREFIX ADMIN_PW UCM_HOST SOA_HOSTS LOAD_BAL_ADDR
